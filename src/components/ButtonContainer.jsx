...
const ButtonContainer = ({onGoalClick, onThoughtCLick}) => {
  return (
    <div className='flex flex-col items-center justify-evenly'>
        <button onClick={onGoalClick} className='mb-4 shadow-2xl bg-white w-full py-2 border-green-400 border-4
        ...
        <button onClick={onThoughtCLick} className='shadow-2xl bg-white w-full py-2 border-green-400 border-4
